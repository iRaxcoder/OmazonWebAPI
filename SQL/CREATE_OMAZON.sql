...
CREATE TABLE OMAZON.CATEGORIA
(
 ID_CATEGORIA INT PRIMARY KEY IDENTITY(1,1),
 NOMBRE_CATEGORIA VARCHAR(32)
);

CREATE TABLE OMAZON.PRODUCTO_CATEGORIA
(
ID_CATEGORIA INT,
ID_PRODUCTO INT,
CONSTRAINT PK_ID_PRODUCTO_ID_CATEGORIA PRIMARY KEY (ID_PRODUCTO,ID_CATEGORIA),
CONSTRAINT FK_ID_PRODUCTO_CAT FOREIGN KEY (ID_PRODUCTO) REFERENCES OMAZON.PRODUCTO(ID_PRODUCTO),
CONSTRAINT FK_ID_CATEGORIA_PROD FOREIGN KEY (ID_CATEGORIA) REFERENCES OMAZON.CATEGORIA(ID_CATEGORIA)
);
...
CREATE TABLE OMAZON.SOLICITUD_PROVEEDOR
(
